      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-7 d-flex flex-column justify-content-center">
            <h3 style="color: #B21909;"><?= $cake["cake_name"] ?></h3>
            <p class="category"><?= $cake["category_name"] ?></p>
            <p class="price" style="color: #52F052;">Rp. <?= number_format($cake["cake_price"]); ?></p>
            <p class="desc"><?= $cake["cake_desc"] ?></p>

            <form action="" method="post">
              <input type="number" name="quantity" class="input-quantity" placeholder="quantity">
              <button type="submit" name="submit" class="btn btn-primary btn-add" style="background-color: #52F052; border:0px;">Add To Cart!</button>
            </form>
          </div>
        </div>
      </div>
